...
export const tr: Dict = {
  ...
  'settings.welcomeTitle': 'Open Maker kurulumu',
  ...
  'settings.agentInstall.pathHint':
    'Bir CLI\'yi npm veya Homebrew ile kurduysan ancak hâlâ kurulu değil olarak görünüyorsa, aracın bin dizininin Open Maker daemon\'unun devraldığı PATH içinde olduğundan emin ol (macOS\'te Terminal ve GUI uygulamalarının PATH\'i farklı olabilir). QUICKSTART.md içindeki "Local agent CLI and PATH" bölümüne bak.',
  'settings.agentInstall.stepOpenLinks': 'Tercih ettiğin ajan için Yükle veya Dokümanlar bağlantısını aç.',
  'settings.agentInstall.stepAuth':
    'Open Maker\'a dönmeden önce sağlayıcı CLI\'sinde kimlik doğrulaması yap (oturum aç veya API kimlik bilgileri ekle).',
  ...
  'settings.mcpServerHint': 'Open Maker\'ı kodlama ajanınız için MCP sunucusu olarak yayınlayın.',
  ...
  'entry.githubStarAria': 'Open Maker\u2019a GitHub üzerinde yıldız ver',
  ...
  'preview.errorBody': 'Örnek HTML\'i alınamadı. Open Maker\'ın çalıştığından emin olup tekrar deneyin.',
  ...
  'pet.tabBuiltInHint': 'Open Maker ile gelen seçili dostlar — birini seç ve sahiplen.',
  ...
  'pet.railShow': 'Evcil hayvan seçicisini göster',
  'pet.railHide': 'Evcil hayvan seçicisini gizle',
  'pet.adopt': 'Sahiplen',
  ...
  'pet.codexBundledTitle': 'Open Maker ile birlikte gelir — indirme gerekmez.',
