...
export const it: Dict = {
  ...
  'settings.agentInstall.pathHint':
    'Se hai installato una CLI con npm o Homebrew e appare ancora come non installata, verifica che la cartella bin dello strumento sia nel PATH ereditato dal daemon Open Maker (Terminale e app GUI possono differire su macOS). Vedi QUICKSTART.md (sezione "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Apri Installa o Documentazione per l\'agente desiderato.',
  'settings.agentInstall.stepAuth':
    'Autenticati con la CLI del provider (login o aggiunta delle credenziali API) prima di tornare in Open Maker.',
  ...
  'settings.mcpServerHint': 'Esponi Open Maker come server MCP per il tuo agente di codice.',
  ...
  'settings.privacyHint': 'Quali dati vengono condivisi con il team di Open Maker',
  'settings.privacyConsentKicker': 'Aiutaci a migliorare Open Maker',
  'settings.privacyConsentLead': 'Open Maker può condividere dati di utilizzo con il nostro team per aiutarci a migliorare. Questo include:',
  ...
  'preview.errorBody': 'Il caricamento dell\'HTML dell\'esempio è fallito. Verifica che Open Maker sia in esecuzione e riprova.',
  ...
  'pet.railAria': 'Selettore animali',
  'pet.railTitle': 'Compagni',
  'pet.railHint': 'Scegli un compagno che fluttua sopra il tuo spazio di lavoro.',
  'pet.railExpand': 'Mostra selettore animali',
  'pet.railCollapse': 'Comprimi selettore animali',
  'pet.railHide': 'Nascondi selettore animali',
  'pet.railShow': 'Mostra selettore animali',
  'pet.railCustomFlavor': 'Il tuo: nome, glifo, colore.',
  'pet.railCustomize': 'Personalizza…',
  'pet.tabBuiltIn': 'Integrati',
  'pet.tabBuiltInHint': 'Compagni forniti con Open Maker — scegline uno e adottalo.',
  ...
  'pet.codexBundledTitle': 'Fornito con Open Maker — nessun download necessario.',
  ...
  'settings.memoryStarterProjectDesc': 'Open Maker v0.5 — editor di design guidato da chat',
