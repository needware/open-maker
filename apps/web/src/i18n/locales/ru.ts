...
export const ru: Dict = {
  ...
  'settings.welcomeTitle': 'Настройте Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Если вы установили CLI через npm или Homebrew, но она всё ещё отмечена как не установленная, убедитесь, что bin-каталог инструмента есть в PATH, который наследует daemon Open Maker (в macOS PATH у Terminal и GUI-приложений может отличаться). См. QUICKSTART.md (раздел "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Откройте Установить или Документация для нужного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдите аутентификацию в CLI поставщика (вход или добавление API-ключей), затем вернитесь в Open Maker.',
  ...
  'settings.mcpServerHint': 'Откройте Open Maker как MCP-сервер для вашего кодинг-агента.',
  ...
  'entry.githubStarAria': 'Поставить Open Maker звезду на GitHub',
  ...
  'preview.errorBody': 'Не удалось получить HTML примера. Убедитесь, что Open Maker запущен, и повторите попытку.',
  ...
  'pet.tabBuiltInHint': 'Подобранные питомцы в комплекте Open Maker — выберите и забирайте.',
  ...
  'pet.railShow': 'Показать выбор питомца',
  'pet.railHide': 'Скрыть выбор питомца',
  'pet.adopt': 'Завести',
  ...
  'pet.codexBundledTitle': 'Поставляется с Open Maker — загрузка не нужна.',
