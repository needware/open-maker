...
export const fa: Dict = {
  ...
  'settings.welcomeTitle': 'Open Maker را راه‌اندازی کنید',
  ...
  'settings.agentInstall.stepAuth':
    'قبل از بازگشت به Open Maker، در CLI ارائه‌دهنده احراز هویت کنید (ورود یا افزودن اطلاعات API).',
  ...
  'settings.mcpServerHint': 'Open Maker را به‌عنوان سرور MCP برای عامل برنامه‌نویسی خود در دسترس قرار دهید.',
  ...
  'entry.githubStarAria': 'به Open Maker در GitHub ستاره بدهید',
  ...
  'preview.errorBody': 'دریافت HTML نمونه با خطا مواجه شد. مطمئن شوید Open Maker در حال اجراست و دوباره تلاش کنید.',
  ...
  'pet.tabBuiltInHint': 'همراهان منتخب همراه Open Maker — یکی را انتخاب و فرزندخوانده کن.',
  ...
  'pet.railShow': 'نمایش انتخابگر همراه',
  'pet.railHide': 'پنهان کردن انتخابگر همراه',
  ...
  'pet.codexBundledTitle': 'همراه Open Maker ارائه می‌شود — نیازی به دانلود نیست.',
