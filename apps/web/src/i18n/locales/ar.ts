...
export const ar: Dict = {
  ...
  'settings.welcomeTitle': 'إعداد Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'إذا ثبّتّ CLI باستخدام npm أو Homebrew وما زال يظهر كغير مثبت، فتأكد من أن مجلد bin للأداة موجود في PATH الذي يرثه daemon الخاص بـ Open Maker (قد يختلف PATH بين Terminal وتطبيقات GUI على macOS). راجع QUICKSTART.md (قسم "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'افتح رابط التثبيت أو الوثائق للوكيل الذي تفضله.',
  'settings.agentInstall.stepAuth':
    'أكمِل المصادقة في CLI الخاص بالمزوّد (تسجيل الدخول أو إضافة بيانات اعتماد API) قبل العودة إلى Open Maker.',
  ...
  'settings.mcpServerHint': 'كشف Open Maker كخادم MCP لوكيل البرمجة الخاص بك.',
  ...
  'entry.githubStarAria': 'منح Open Maker نجمة على GitHub',
  ...
  'preview.errorBody': 'فشل جلب HTML الخاص بالمثال. تأكد من تشغيل Open Maker ثم أعد المحاولة.',
  ...
  'pet.railShow': 'إظهار منتقي الحيوان الأليف',
  'pet.railHide': 'إخفاء منتقي الحيوان الأليف',
  'pet.tabBuiltIn': 'مدمج',
  'pet.tabBuiltInHint': 'رفقاء منتقون مدمجون مع Open Maker - اختر واحداً وتبنَّه.',
  ...
  'pet.codexBundledTitle': 'يأتي مع Open Maker - لا حاجة للتحميل.',
