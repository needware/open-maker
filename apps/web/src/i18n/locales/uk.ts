...
export const uk: Dict = {
  ...
  'settings.welcomeTitle': 'Налаштування Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Якщо ви встановили CLI через npm або Homebrew, але вона все ще відображається як не встановлена, переконайтеся, що bin-каталог інструмента є у PATH, який успадковує daemon Open Maker (у macOS PATH у Terminal і GUI-застосунків може відрізнятися). Див. QUICKSTART.md (розділ "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Відкрийте Встановити або Документація для потрібного агента.',
  'settings.agentInstall.stepAuth':
    'Пройдіть автентифікацію у CLI постачальника (увійдіть або додайте API-облікові дані), потім поверніться до Open Maker.',
  ...
  'settings.mcpServerHint': 'Відкрийте Open Maker як MCP-сервер для вашого кодинг-агента.',
  ...
  'entry.tabWorkspace': 'Робочий простір',
  ...
  'entry.githubStarAria': 'Поставити Open Maker зірку на GitHub',
  ...
  'preview.errorBody': 'Не вдалося отримати HTML прикладу. Переконайтеся, що Open Maker запущено, і повторіть спробу.',
  ...
  'pet.railShow': 'Показати вибір улюбленця',
  'pet.railHide': 'Сховати вибір улюбленця',
  'pet.tabBuiltIn': 'Вбудовані',
  'pet.tabBuiltInHint': 'Кураторські супутники в комплекті з Open Maker — виберіть один та встановіть.',
  ...
  'pet.codexBundledTitle': 'Поставляється з Open Maker — завантаження не потрібне.',
