...
export const pl: Dict = {
  ...
  'settings.welcomeTitle': 'Skonfiguruj Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Jeśli zainstalowano CLI przez npm lub Homebrew, ale nadal widnieje jako niezainstalowana, upewnij się, że katalog bin narzędzia jest w PATH dziedziczonym przez daemon Open Maker (na macOS PATH w Terminalu i aplikacjach GUI może się różnić). Zobacz QUICKSTART.md (sekcja "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Otwórz Zainstaluj lub Dokumentacja dla wybranego agenta.',
  'settings.agentInstall.stepAuth':
    'Uwierzytelnij się w CLI dostawcy (zaloguj się lub dodaj dane API), zanim wrócisz do Open Maker.',
  ...
  'settings.mcpServerHint': 'Udostępnij Open Maker jako serwer MCP dla swojego agenta kodu.',
  ...
  'entry.tabWorkspace': 'Obszar roboczy',
  ...
  'entry.githubStarAria': 'Daj Open Maker gwiazdkę na GitHubie',
  ...
  'preview.errorBody': 'Nie udało się pobrać kodu HTML przykładu. Upewnij się, że Open Maker jest uruchomiony, i spróbuj ponownie.',
  ...
  'pet.tabBuiltInHint': 'Towarzysze dołączeni do Open Maker — wybierz jednego i adoptuj.',
  ...
  'pet.railShow': 'Pokaż wybór zwierzaka',
  'pet.railHide': 'Ukryj wybór zwierzaka',
  'pet.adopt': 'Adoptuj',
  ...
  'pet.codexBundledTitle': 'Dostarczany z Open Maker — bez pobierania.',
