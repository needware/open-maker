...
export const id: Dict = {
  ...
  'settings.welcomeTitle': 'Siapkan Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Jika Anda memasang CLI dengan npm atau Homebrew tetapi masih tampil sebagai belum terpasang, pastikan direktori bin alat ada di PATH yang diwarisi daemon Open Maker (PATH Terminal dan aplikasi GUI bisa berbeda di macOS). Lihat QUICKSTART.md (bagian "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Buka Instal atau Dokumentasi untuk agen pilihan Anda.',
  'settings.agentInstall.stepAuth':
    'Lakukan autentikasi di CLI vendor (masuk atau tambahkan kredensial API) sebelum kembali ke Open Maker.',
  ...
  'settings.mcpServerHint': 'Ekspos Open Maker sebagai server MCP untuk agen koding Anda.',
  ...
  'entry.githubStarAria': 'Beri star Open Maker di GitHub',
  ...
  'preview.errorBody': 'Pengambilan HTML contoh gagal. Pastikan Open Maker berjalan, lalu coba lagi.',
  ...
  'pet.railShow': 'Tampilkan pemilih hewan peliharaan',
  'pet.railHide': 'Sembunyikan pemilih hewan peliharaan',
  'pet.tabBuiltIn': 'Bawaan',
  'pet.tabBuiltInHint': 'Pet pilihan yang disertakan dengan Open Maker - pilih satu lalu adopsi.',
  ...
  'pet.codexBundledTitle': 'Disertakan dengan Open Maker - tidak perlu diunduh.',
