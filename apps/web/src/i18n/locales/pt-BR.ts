...
export const ptBR: Dict = {
  ...
  'settings.welcomeTitle': 'Configure o Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Se você instalou uma CLI com npm ou Homebrew e ela ainda aparece como não instalada, garanta que o diretório bin da ferramenta esteja no PATH herdado pelo daemon do Open Maker (Terminal e apps GUI podem diferir no macOS). Veja QUICKSTART.md (seção "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Abra Instalar ou Docs para o agente desejado.',
  'settings.agentInstall.stepAuth':
    'Autentique-se na CLI do fornecedor (faça login ou adicione credenciais de API) antes de voltar ao Open Maker.',
  ...
  'settings.mcpServerHint': 'Exponha o Open Maker como servidor MCP para o seu agente de código.',
  ...
  'entry.githubStarAria': 'Dar uma estrela ao Open Maker no GitHub',
  ...
  'preview.errorBody': 'A obtenção do HTML do exemplo falhou. Verifique se o Open Maker está em execução e tente novamente.',
  ...
  'pet.tabBuiltInHint': 'Companheiros incluídos no Open Maker — escolha um e adote.',
  ...
  'pet.railShow': 'Mostrar seletor de mascotes',
  'pet.railHide': 'Ocultar seletor de mascotes',
  'pet.adopt': 'Adotar',
  ...
  'pet.codexBundledTitle': 'Já vem com o Open Maker — sem download.',
