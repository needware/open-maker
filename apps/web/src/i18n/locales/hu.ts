...
export const hu: Dict = {
  ...
  'settings.welcomeTitle': 'Open Maker beállítása',
  ...
  'settings.agentInstall.pathHint':
    'Ha npm-mel vagy Homebrew-val telepítettél egy CLI-t, de továbbra is nincs telepítve állapotban látszik, ellenőrizd, hogy az eszköz bin könyvtára benne van-e abban a PATH-ban, amit az Open Maker daemon örököl (macOS-en a Terminal és a GUI appok PATH-ja eltérhet). Lásd a QUICKSTART.md "Local agent CLI and PATH" szakaszát.',
  'settings.agentInstall.stepOpenLinks': 'Nyisd meg a Telepítés vagy Dokumentáció hivatkozást a kívánt ügynöknél.',
  'settings.agentInstall.stepAuth':
    'Hitelesíts a szolgáltató CLI-jében (bejelentkezés vagy API hitelesítő adatok megadása), mielőtt visszatérsz az Open Makerhoz.',
  ...
  'settings.mcpServerHint': 'Tedd elérhetővé az Open Makert MCP-szerverként a kódügynököd számára.',
  ...
  'entry.githubStarAria': 'Csillagozd meg az Open Maker projektet a GitHubon',
  ...
  'preview.errorBody': 'A példa HTML-jének letöltése meghiúsult. Győződj meg róla, hogy az Open Maker fut, majd próbáld újra.',
  'preview.retry': 'Újra',
  ...
  'pet.railShow': 'Kedvenc kiválasztó megjelenítése',
  'pet.railHide': 'Kedvenc kiválasztó elrejtése',
  'pet.tabBuiltIn': 'Beépített',
  'pet.tabBuiltInHint': 'Az Open Makernal csomagolt társak — válassz egyet és fogadd örökbe.',
  ...
  'pet.codexBundledTitle': 'Az Open Makergal érkezik — letöltés nem szükséges.',
