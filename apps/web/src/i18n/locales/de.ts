...
export const de: Dict = {
  ...
  'settings.welcomeTitle': 'Open Maker einrichten',
  ...
  'settings.agentInstall.stepAuth':
    'Authentifizieren Sie sich mit der Anbieter-CLI (anmelden oder API-Zugangsdaten setzen), bevor Sie zu Open Maker zurueckkehren.',
  ...
  'settings.mcpServerHint': 'Stelle Open Maker als MCP-Server für deinen Coding-Agent bereit.',
  ...
  'entry.tabWorkspace': 'Arbeitsbereich',
  ...
  'entry.githubStarAria': 'Open Maker auf GitHub einen Stern geben',
  ...
  'preview.errorBody': 'Das Beispiel-HTML konnte nicht abgerufen werden. Stelle sicher, dass Open Maker läuft, und versuche es erneut.',
  ...
  'pet.tabBuiltInHint': 'Mit Open Maker gebündelte Begleiter — auswählen und adoptieren.',
  ...
  'pet.railShow': 'Haustier-Auswahl anzeigen',
  ...
  'pet.codexBundledTitle': 'Wird mit Open Maker ausgeliefert — kein Download nötig.',
