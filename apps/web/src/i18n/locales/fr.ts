...
export const fr: Dict = {
  ...
  'settings.welcomeTitle': 'Configurer Open Maker',
  ...
  'settings.agentInstall.pathHint':
    'Si vous avez installé une CLI avec npm ou Homebrew et qu\'elle apparaît toujours comme non installée, vérifiez que le dossier bin de l\'outil est dans le PATH hérité par le daemon Open Maker (Terminal et apps GUI peuvent différer sur macOS). Voir QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Ouvrez Installer ou Docs pour l\'agent souhaité.',
  'settings.agentInstall.stepAuth':
    'Authentifiez-vous avec la CLI du fournisseur (connexion ou ajout des identifiants API) avant de revenir dans Open Maker.',
  ...
  'settings.mcpServerHint': 'Exposez Open Maker comme serveur MCP pour votre agent de code.',
  ...
  'entry.tabWorkspace': 'Espace de travail',
  ...
  'entry.githubStarAria': 'Mettre une étoile à Open Maker sur GitHub',
  ...
  'preview.errorBody': 'Le chargement du HTML de l\'exemple a échoué. Vérifiez qu\'Open Maker est en cours d\'exécution et réessayez.',
  ...
  'pet.railShow': "Afficher le sélecteur d'animaux",
  'pet.railHide': "Masquer le sélecteur d'animaux",
  'pet.tabBuiltIn': 'Intégrés',
  'pet.tabBuiltInHint': 'Compagnons fournis avec Open Maker — choisissez-en un et adoptez-le.',
  ...
  'pet.codexBundledTitle': 'Livré avec Open Maker — aucun téléchargement nécessaire.',
