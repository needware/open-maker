...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'Open Maker artifact';
...
- Keep generated product UI free of Open Maker chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or Open Maker chrome in the production UI.
