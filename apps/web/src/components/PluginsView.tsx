...
const PLUGIN_SHARE_DETAILS: Record<PluginShareAction, {
  ...
  'publish-github': {
    ...
    fallbackDescription:
      'Creates a public GitHub repository for this local Open Maker plugin.',
    confirmLabel: 'Start publishing',
    steps: [
      'Create a new Open Maker project for the publish workflow.',
  ...
  'contribute-open-design': {
    eyebrow: 'Open Maker pull request',
    fallbackTitle: 'Contribute Plugin to Open Maker',
    fallbackDescription:
      'Opens a pull request that adds this plugin to the Open Maker community catalog.',
    confirmLabel: 'Start contribution',
    steps: [
      'Create a new Open Maker project for the contribution workflow.',
      'Copy this plugin into that project as isolated source context.',
