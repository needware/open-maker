  ...
  it('confirms a plugin share action before starting the GitHub repo task', async () => {
    mockedListPlugins.mockResolvedValue([
      ...
      makePlugin(
        ...
        'Creates a public GitHub repository for a local Open Maker plugin using the GitHub CLI.',
      ),
      makePlugin(
        'od-plugin-contribute-open-design',
        'bundled',
        'bundled',
        'Contribute Plugin to Open Maker',
        'Opens a pull request that adds a local Open Maker plugin to the Open Maker community catalog.',
      ),
    ]);
