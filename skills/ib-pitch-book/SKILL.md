...
repackaged as an Open Make `deck` skill.
...
Follow Open Make's deck export path for the active session (HTML / PDF /
PPTX per daemon capabilities).

## Relationship to Open Make financial skills
...
original adaptation for Open Make.
